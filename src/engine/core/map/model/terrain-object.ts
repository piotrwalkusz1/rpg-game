import { PositionComponentsCollection } from 'engine/core/map/component/position-component';
import type { Law } from 'engine/modules/law/law';
import type { TranslatableText } from '../../../../i18n/translatable-text';
import { ArrayUtils } from '../../../../utils/array-utils';
import { OneToManyForeignKey } from '../../../../utils/cache-relationship-utils';
import { areSame } from '../../../../utils/object-utils';
import type { LawContext } from '../../../modules/law/law-context';
...
export class TerrainObject implements DetectorContext, TraitOwner, NarrationProviderOwner, LawContext {
  ...
  readonly positionComponents: PositionComponentsCollection;
  readonly laws: Law[] = [];
  ...
  constructor({ type, field, hidden }: { type: TerrainObjectType; field?: MapField; hidden?: boolean }) {
    ...
    this.positionComponents = new PositionComponentsCollection(new TerrainObjectPosition(this, this.type.defaultCharacterPlacement));
    this.traits = [
